...
#To run
#parallel -a ./02_info/regions.txt -j 8 srun -p ibis_medium -c 5 --mem=20G --time=1-00:00 -J 05_ngsLD_{} -o 05_ngsLD_per_chr_{}_%j.log /bin/sh 01_scripts/05_run_ngsLD_parallel.sh {} &
