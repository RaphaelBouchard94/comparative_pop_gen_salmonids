...
#parallel -a ./02_info/regions.txt -j 10 srun -p ibis_small -c 2 --mem=25G --time=1-00:00 -J 03_saf_maf_gl_all_parallel_{} -o  03_saf_maf_gl_all_parallel_{}_%j.log /bin/sh 01_scripts/03_saf_maf_gl_all_parallel_valeria.sh {} &
#
