...
LD_PRUNED_LIST=all_maf"$MIN_MAF"pctind"$PERCENT_IND"_maxdepth"$MAX_DEPTH_FACTOR"_ALL_CHR.singletons.pruned.ld.tsv
LD_PRUNED_BEAGLE=all_maf"$MIN_MAF"pctind"$PERCENT_IND"_maxdepth"$MAX_DEPTH_FACTOR"_ALL_CHR.singletons.pruned.beagle.gz 

python 01_scripts/Scripts/beagle_extract_wanted_snps.py 03_saf_maf_gl_all/$BEAGLE_FILE 05_ngsLD/$LD_PRUNED_LIST 05_ngsLD/$LD_PRUNED_BEAGLE
