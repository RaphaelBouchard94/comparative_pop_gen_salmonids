...
#To run:
#parallel -a 10_clusters/pop.txt -j 10 srun -p medium -c 5 --mem=100G --time=5-00:00 -J saf_{} -o 11_saf_maf_per_pop_{}_%j.log /bin/sh 01_scripts/11_calculate_saf_maf_per_pop.sh {} &
...
-b 10_clusters/"$POP"sampledbam.filelist \
