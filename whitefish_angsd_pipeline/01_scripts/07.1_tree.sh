...
pcangsd -b 06_pruned_singletons/all_maf0.05pctind0.8_maxdepth10_ALL_CHR.singletons.pruned.beagle.gz \
	-e 4 \
	--tree \
	-t $NB_CPU \
	-o 07_pca/all_maf0.05pctind0.8_maxdepth10_ALL_CHR.singletons.pruned
