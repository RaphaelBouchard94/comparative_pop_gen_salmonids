...
#To run:
#parallel -a 02_info/pop.txt -j 12 srun -p medium -c 2 --mem=20G --time=5-00:00 -J saf_{} -o 11_saf_maf_per_pop_{}_%j.log /bin/sh 01_scripts/11_calculate_saf_maf_per_site.sh {} &
